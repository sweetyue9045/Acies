...
export default function HContent() {
    ...
    const scrolltop = () => {
        v_top = [
            ...
            document.getElementById("story").offsetTop,
            document.getElementById("tobbi").offsetTop,
            document.getElementById("magic").offsetTop,
            document.getElementById("ordeal").offsetTop,
            document.getElementById("crisis").offsetTop,
            document.getElementById("awards").offsetTop,
